"""
galaxy_gov.shared.enforcement.data_fgac — Gap 1: data-layer guardrails (FGAC).
...
class DataAccessMediator:
    ...
    def __init__(
        ...
        drift_detector: Optional[Any] = None,   # galaxy_gov.shared.enforcement.data_drift.DataAccessDriftDetector
        authorizer: Optional[Any] = None,        # galaxy_gov.shared.enforcement.policy_engine.CedarAuthorizer (standards-based)
    ) -> None:
