"""
galaxy_gov/remote/identity_store.py — the authority-side identity binding store.
...
``galaxy_gov.remote.registrar``.

Storage format (``GOV_IDENTITY_STORE``, default
``galaxy_gov/configs/identity-bindings.yaml``)::
...
class IdentityStore:
    ...
    def _write(self, bindings: dict[str, IdentityBinding]) -> None:
        ...
        body = (
            ...
            "(galaxy_gov/remote/registrar.py).\n"
