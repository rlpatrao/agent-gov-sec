"""
galaxy_gov.agentcore.cedar_export — generate AgentCore Policy (Cedar) from the registry.
...
`python -m galaxy_gov.agentcore.cedar_export` prints the statements for the live
...
from galaxy_gov.policy_export import KNOWN_AGENT_TYPES, resolve_policy
...
def export_cedar(**kwargs) -> str:
    ...
    header = ("// Generated from the governance policy registry (galaxy_gov.policy_export).\n"
