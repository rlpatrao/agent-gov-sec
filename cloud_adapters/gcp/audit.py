"""
cloud_adapters.gcp.audit — BigQueryHashChainBackend (WS6).
...
``cloud_adapters/azure/audit.PostgresHashChainBackend`` and
``cloud_adapters/aws/audit.DynamoDbHashChainBackend``). Each row carries
