"""
framework_adapters.langgraph.bedrock_gateway — client-side model for the apigw-bedrock path.
...
The server side is ``cloud_adapters/aws/infra/lambda/bedrock_proxy.py`` (API Gateway →
