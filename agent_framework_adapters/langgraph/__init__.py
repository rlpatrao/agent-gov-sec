"""
agent_framework_adapters.langgraph — the LangGraph / LangChain framework axis.

This package is the **framework binding** for governing LangGraph agents, the
non-MAF counterpart to ``cloud_adapters/azure/maf/``. It proves the platform's
...
from agent_framework_adapters.langgraph.governance import (
    GalaxyGuardMiddleware,
    GovernanceViolation,
    build_langgraph_governance,
)
from agent_framework_adapters.langgraph.runtime import FakeToolCallingModel, build_chat_model, scripted_model
