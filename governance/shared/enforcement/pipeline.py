"""
governance.shared.enforcement.pipeline — the framework-neutral guard pipeline.
...
def _register_sweep_guards(pipeline: "GuardPipeline", agent_id: str) -> list[str]:
    ...
    if on(flags.MCP_RESPONSE_SCAN):
        from governance.shared.enforcement.mcp_response_guard import McpResponseGuard
        mr = McpResponseGuard()
