"""
governance.shared.enforcement.reasoning_guard — Gap 4: reasoning-chain guardrails.
...
class ReasoningStepValidator:
    ...
    def __init__(self, mediator: Optional[Any] = None, authorizer: Optional[Any] = None) -> None:
        # mediator:   governance.shared.enforcement.data_fgac.DataAccessMediator (data_access steps)
        # authorizer: governance.shared.enforcement.policy_engine.CedarAuthorizer (standards-based
