"""
governance.remote.enforce — transport-neutral out-of-process enforcement.
...
these calls and back. That is why this module lives under `governance/remote`
...
from governance.shared.enforcement.session import EnforcementSession, Verdict, build_enforcement
from governance.shared.policy_registry import authorize_recipient, policy_for
