...
| `core/a2a/dispatcher.py` | 245 | Audited A2A dispatch with trace-linking — *(b)* for audit (uses `agent_os` `GovernanceAuditLogger`), but the dispatch/envelope protocol is ours. |
